  ...
  <section class="mt-12 space-y-4">
    ...
    <div class="overflow-x-auto overscroll-x-contain">
      <div class="flex space-x-4">
        <div
          v-for="url in proposal.galleryUrls"
          :key="url"
          class="h-40 w-64 flex-none overflow-hidden rounded-2xl bg-slate-200 shadow-md border border-slate-200/70 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-lg"
        >
          <div class="relative h-full w-full">
            <img :src="url" alt="Deck preview" class="h-full w-full object-cover" />
