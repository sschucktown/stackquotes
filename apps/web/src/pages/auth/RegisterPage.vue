      ...
      <Transition name="fade">
        ...
        >
          <div class="flex flex-col items-center text-center">
            ...
            />
            <h1 class="mt-4 text-2xl font-semibold text-slate-900">Create your account</h1>
            <p class="mt-2 text-sm text-slate-600">Start building polished proposals in minutes.</p>
          </div>
          ...
          <p class="mt-4 text-center text-sm text-slate-600">
            ...
            <RouterLink class="font-medium text-[#3A7D99] hover:underline" to="/login">Sign in</RouterLink>
          </p>
        </div>
      </Transition>
    </div>
...
const getIntentFromQuery = (): string | undefined => firstQueryString(route.query.intent);
